...
<script type="text/javascript">
	...
	$(function(){
		...
		//这个方法是我自己测试的，用来看看点击checkbox复选框的时候，能不能弹出来一个id
		$("#tBody").on("click","input[type='checkbox']",function (){
			var a = $("#tBody input[type=checkbox]:checked").val();
			alert(a);
		})

		//给解除关联的市场活动按钮添加单击事件，因为这个数据是动态的，可能还没完成的时候，页面就已经出来了，所以我们这里采用on
		$("#aaa").on("click","a",function (){
			//var a = $("#tBody input[type=checkbox]:checked").val();
			alert("加油，努力适应工作,适应新环境，感谢主耶稣，阿门,准备回归");
			//收集参数
			alert("1")
			// var ab = $("#aaa a").attr("activityId");
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3 id="${clue.id}">${requestScope.clue.fullname}${requestScope.clue.appellation} <small>动力节点</small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${clue.id}</b></div>
